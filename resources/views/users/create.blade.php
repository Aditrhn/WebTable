                            ...
                            <div class="col-lg-6 col-7">
                                ...
                                <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                                    <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                        ...
                                        <li class="breadcrumb-item"><a
                                                href="{{ URL::route('user.index') }}">User
                                                Management</a></li>
        ...
        <div class="row">
            <div class="col">
                <div class="card shadow">
                    ...
                    <form action="{{ URL::route('create.success') }}" method="POST">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" class="form-control form-control-alternative"
                                        id="exampleFormControlInput1" value="{{$password}}" name="password">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-footer py-4">
                            <nav class="d-flex justify-content-end" aria-label="...">
                                <div class="col-4 text-right">
                                    <a href="{{ URL::route('user.index') }}" class="btn btn-md btn-secondary">Cancel</a>
